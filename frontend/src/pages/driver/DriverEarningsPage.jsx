      ...
      <div className="grid grid-cols-2 gap-3">
        {[
          ...
          <div key={label} className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
            ...
            <p className="text-gray-400 text-xs">{rides} rides</p>
          </div>
        ))}
      </div>

      <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
        <h3 className="font-semibold text-surface-900 mb-3 flex items-center gap-2"><Car size={16} className="text-brand-500" />Payout Info</h3>
        <p className="text-gray-600 text-sm">You earn 80% of every fare. Payouts are processed weekly to your registered bank account.</p>
      </div>
    </div>
  );
}
