      ...
      `}>
        <div className="p-6 border-b border-surface-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-display font-bold text-surface-900 text-lg leading-none">Driver</p>
        ...
        <div className="p-4 border-t border-surface-100">
          <Link to="/" className="flex items-center gap-3 px-4 py-3 rounded-2xl text-surface-600 hover:text-surface-900 hover:bg-surface-100 font-medium transition-all duration-200 mb-1">
            <LayoutDashboard size={18} /><span>User Dashboard</span>
          </Link>
          <button onClick={handleLogout} className="w-full flex items-center gap-3 px-4 py-3 rounded-2xl text-red-500 hover:bg-red-50 hover:text-red-600 font-medium transition-all duration-200">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-lg border-b border-surface-100 px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between">
            <button onClick={() => setSidebarOpen(true)} className="lg:hidden p-2 rounded-xl hover:bg-surface-100 transition-colors">
              <Menu size={20} />
            </button>
            <h1 className="font-display font-bold text-surface-900 text-lg">Driver Portal</h1>
